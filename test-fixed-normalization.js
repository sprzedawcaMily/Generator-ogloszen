// Test poprawionej funkcji normalizacji rozmiarów
console.log('🧪 Testing FIXED size normalization for Vinted size selection...\n');
...
console.log('Testing FIXED normalizeSize function:');
...
console.log('\n🔍 Testing size finding after FIXED normalization:');
